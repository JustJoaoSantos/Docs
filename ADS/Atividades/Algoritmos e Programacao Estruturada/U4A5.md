# Desafio
- realizar a implementacao de um sistema bancario simples em c, onde cada cliente possui uma conta com saldo
- desenvolva funcoes que realizem funcoes bancarias simples, como deposito, saque e tranferencia
	- definicao da estrutura conta 
	- funcao para depostio,  saque e tranferencia 
	- apresentacao de resultados (siteuacao atual de cada conta apos cada operacao)
	- tratamento de erros
