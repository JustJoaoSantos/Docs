# Desafio
Uma escola deseja automatizar o processo de gerenciamento de notas e informacao dos alunos
A escola possui varias turmas, cada turma tem varios alunos e cada aluno precisa de informacoes como nome, numero de matricula e notas em varias disciplinas
- Crie um program em C capaz de:
	- Cadastrar aluno em uma turma;
	- Lancar notas de alunos;
	- Calcular a media de uma turma;
	- Gerar o relatorio de turma, exibindo as informacoes de todos os alunos pertencetes a turma 
