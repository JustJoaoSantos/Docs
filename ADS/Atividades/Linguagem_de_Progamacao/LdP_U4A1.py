...
<body style="font-family: 'Arial', sans-serif; background-color: #f8f8f8; margin: 0; padding: 0;">
    ...
    <header style="text-align: center; background-color: #3498db; color: #fff; padding: 20px;">
        ...
        <h1 style="margin: 0;">Joao Vitor S. dos Santos</h1>

        <p style="margin: 5px 0;">Desenvolvedor Back-End</p>
    ...
    <section style="margin: 20px; text-align: center;">
        ...
        <div id="informacoes-pessoais" style="max-width: 400px; margin: 0 auto;">
            ...
            <p>Interesses: Back-End Development, Programação, GameDev, etc.</p>
    ...
    <section style="margin: 20px; text-align: center;">
        ...
        <ul style="list-style: none; padding: 0;">
            ...
            <li>Linguagens: Python, HTML, CSS, JavaScript, C, C++, C#</li>
    ...
    <footer style="text-align: center; margin-top: 20px;">
        ...
        <a href="https://www.linkedin.com/in/joaosantos/" target="_blank" style="margin: 0 10px; color: #3498db; text-decoration: none;">LinkedIn</a>
